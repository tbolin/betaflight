...
FAST_CODE void gyroFiltering(timeUs_t currentTimeUs)
{
    ...
    const fpVector3_t gyroVector = {{ gyro.gyroADCf[FD_ROLL], gyro.gyroADCf[FD_PITCH], gyro.gyroADCf[FD_YAW] }};

    extern void gyroSendTo_imu(const fpVector3_t* g, const uint32_t stampCycles, const bool overflow);
